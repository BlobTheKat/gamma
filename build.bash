...
printf "/// <reference path=\"./gamma.d.ts\" />\nexport {}\ndeclare global{\n\tnamespace GammaInstance{ type $dst = typeof GammaInstance.$dst; }\n\tnamespace Gamma{\n\t\tfunction $dst(): GammaInstance.$dst\n\t\tfunction $dst(o: object): asserts o is GammaInstance.$dst\n\t}\nnamespace GammaInstance.$dst{\n" > "$dst.d.ts"
fi
